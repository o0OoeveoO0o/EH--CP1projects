#Evans Hidalgo Unit one final project M4x

#these are questions
name = input ("What is your name? ")
age = input ("How old are you? ")
job = input ("What is your job? ")
activities = input ("What do you like to do in your free time? ")
food = input ("What is your favorite food? ")
place = input ("Where do you live? ")
animals = input ("Which animal from the world you like the most? ")
